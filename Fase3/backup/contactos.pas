    ...
    begin
      ...
      begin
        if (d.JSONType = jtString) then
          ...
          Exit(d.AsJSON); // fallback (número/boolean lo convertimos a texto)
      end;
    end;
  end;
...
begin
  ...
  try
    ...
    // Acepta "usuarios" o "Usuarios" como arreglo principal
    arrUsers := nil;
    ...
    begin
      ...
      // Si no hay email válido de dueño, ignoramos este bloque
      ...
      // Arreglo de contactos: "Contactos" o "contactos" o "friends"
      arrContacts := FindArrayAnyKey(item, ['Contactos', 'contactos', 'friends']);
      if arrContacts = nil then
      begin
        // sin contactos para este owner
        Continue;
      end;

      for j := 0 to arrContacts.Count - 1 do
      begin
        // Cada contacto puede ser string (username o email)
        ...
        // Si trae '@' asumimos que ya es email; si no, lo resolvemos como username
        ...
        begin
          ...
          if Assigned(uContact) then
            ...
            contactEmail := ''; // no existe ese usuario
        end;
        ...
        begin
          Inc(totalIgnorados); // evitar auto-contacto
          Continue;
        end;
        if ExisteContactoEmail(ListaContactos, ownerEmail, contactEmail) then
        begin
          Inc(totalIgnorados); // ya existe
          Continue;
        end;
